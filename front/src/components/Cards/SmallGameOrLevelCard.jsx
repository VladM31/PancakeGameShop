...
function SmallGameOrLevelCard({
    ...
    return (
        <StyledCard onClick={isCartCard ? e => navigationToGameOrLevel(e, gameId, levelId) : null}
            ...
            <CardContent sx={{display: 'flex', flexDirection: 'row'}}>
                ...
                <CardContent
                    ...
                    <CardContent sx={isLibraryCard || isLibraryLevelCard ? {
                        display: 'flex',
                        height: '150px',
                    ...
                    <CardContent sx={{
                    ...
                    }}>
                        {
                            isLibraryCard || isLibraryLevelCard ? (
                                <Link style={{color: '#fff', marginTop: '15px'}}
                                      to={isLibraryLevelCard ? `/game/${gameId}/level/${levelId}` : `/game/${gameId}`}>
                                    Переглянути
                                </Link>
                            ) : (
                        ...
                        }
                        {
                            isLibraryCard ? (
                                ...
                                isLibraryLevelCard ? null : !isGamePageCard ? <Button variant="contained" color="error"
                                                                                      onClick={(e) => removeHandler(e)}>Видалити</Button> :
